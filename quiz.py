...
def signUpPage():
    ...
    def addUserToDataBase():
        ...
        password = pas.get()
        country = c.get()
        if( fullname != "" and username != "" and password!="" and country!=""):
...
def menu():
    ...
    level = Label(menu_frame,text='Select your Subject!!!',bg="white",font="calibri 18")
    level.place(relx=0.25,rely=0.3)
    
    
    var = IntVar()
    easyR = Radiobutton(menu_frame,text='C++',bg="white",font="calibri 16",value=1,variable = var)
    easyR.place(relx=0.25,rely=0.4)
    
    mediumR = Radiobutton(menu_frame,text='Java',bg="white",font="calibri 16",value=2,variable = var)
    mediumR.place(relx=0.25,rely=0.5)
    
    hardR = Radiobutton(menu_frame,text='Python',bg="white",font="calibri 16",value=3,variable = var)
